...
public:
    ...
    void setupUi(QDialog *NewPatientDialog)
    {
        ...
        NewPatientDialog->resize(400, 430);
        formLayoutWidget = new QWidget(NewPatientDialog);
        formLayoutWidget->setObjectName(QStringLiteral("formLayoutWidget"));
        formLayoutWidget->setGeometry(QRect(9, 9, 381, 407));
    ...
    {
        NewPatientDialog->setWindowTitle(QApplication::translate("NewPatientDialog", "New customer", 0));
        lastNameLabel->setText(QApplication::translate("NewPatientDialog", "Last name :", 0));
        firstNameLabel->setText(QApplication::translate("NewPatientDialog", "First name :", 0));
        addressLabel->setText(QApplication::translate("NewPatientDialog", "Address :", 0));
        cityLabel->setText(QApplication::translate("NewPatientDialog", "City :", 0));
        postalCodeLabel->setText(QApplication::translate("NewPatientDialog", "Postal code :", 0));
        dayOfConsultationLabel->setText(QApplication::translate("NewPatientDialog", "Day of consultation :", 0));
        durationLabel->setText(QApplication::translate("NewPatientDialog", "Duration :", 0));
        priorityLabel->setText(QApplication::translate("NewPatientDialog", "Priority :", 0));
        ressourcesLabel->setText(QApplication::translate("NewPatientDialog", "Ressources :", 0));
        commentLabel->setText(QApplication::translate("NewPatientDialog", "Comment :", 0));
        phoneLabel->setText(QApplication::translate("NewPatientDialog", "Phone :", 0));
        cancelButton->setText(QApplication::translate("NewPatientDialog", "Cancel", 0));
        okButton->setText(QApplication::translate("NewPatientDialog", "OK", 0));
    } // retranslateUi
