...
public:
    ...
    void setupUi(QDialog *NewStaffDialog)
    {
        ...
        NewStaffDialog->resize(400, 197);
        formLayoutWidget_2 = new QWidget(NewStaffDialog);
        formLayoutWidget_2->setObjectName(QStringLiteral("formLayoutWidget_2"));
        formLayoutWidget_2->setGeometry(QRect(9, 9, 381, 176));
    ...
    {
        NewStaffDialog->setWindowTitle(QApplication::translate("NewStaffDialog", "New staff", 0));
        firstNameLabel->setText(QApplication::translate("NewStaffDialog", "First name :", 0));
        lastNameLabel->setText(QApplication::translate("NewStaffDialog", "Last name :", 0));
        typeLabel->setText(QApplication::translate("NewStaffDialog", "Type :", 0));
        loginLabel->setText(QApplication::translate("NewStaffDialog", "Login :", 0));
        passwordLabel->setText(QApplication::translate("NewStaffDialog", "Password :", 0));
        okButton->setText(QApplication::translate("NewStaffDialog", "OK", 0));
        cancelButton->setText(QApplication::translate("NewStaffDialog", "Cancel", 0));
    } // retranslateUi
