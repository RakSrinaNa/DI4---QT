...
const QMetaObject Staff::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Staff.data,
      qt_meta_data_Staff,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Staff::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Staff.stringdata0))
        return static_cast<void*>(const_cast< Staff*>(this));
