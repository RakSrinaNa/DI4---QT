...
public:
    ...
    void retranslateUi(QDialog *Login)
    {
        ...
        loginEdit->setText(QApplication::translate("Login", "Admin", Q_NULLPTR));
        label_2->setText(QApplication::translate("Login", "Password", Q_NULLPTR));
        passwordEdit->setText(QApplication::translate("Login", "Password", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("Login", "Cancel", Q_NULLPTR));
        okButton->setText(QApplication::translate("Login", "Connect", Q_NULLPTR));
    } // retranslateUi
